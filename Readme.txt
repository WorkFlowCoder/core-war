...
Pour lancer cette application :
	...
	Core-War.sh : permet de lancer le core-war en mode graphique.
	Génération-Warriors : permet de lancer l'algorithme génétique avec des variables 
	prédéfinies.

	Rapport:
	
	Le rapport se situe dans le dossier expression.
	Dans le dossier expression/rapport, on peut trouver les fichiers .tex



Information sur le jeu :

	Le jeu se joue exclusivement en mode graphique.
